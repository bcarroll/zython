...
grep -q 'enable_uart=1' "$project_dir/Makefile"
grep -q 'hdmi_force_hotplug=1' "$project_dir/Makefile"
grep -q 'hdmi_group=2' "$project_dir/Makefile"
grep -q 'hdmi_mode=4' "$project_dir/Makefile"
