...
- `make stage-sdcard` also appends `hdmi_force_hotplug=1`, `hdmi_group=2`, `hdmi_mode=4`, and `disable_overscan=1` to favor a conservative 640x480 HDMI mode that is broadly compatible for early bring-up
